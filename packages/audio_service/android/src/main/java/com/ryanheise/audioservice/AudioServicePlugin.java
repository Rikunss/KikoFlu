        ...
        public void onMethodCall(MethodCall call, Result result) {
            try {
                ...
                case "setMediaItem": {
                    Executors.newSingleThreadExecutor().execute(() -> {
                        try {
                            ...
                            if (AudioService.instance != null) { AudioService.instance.setMetadata(mediaMetadata); }
                ...
                case "setQueue": {
                    Executors.newSingleThreadExecutor().execute(() -> {
                        try {
                            ...
                            if (AudioService.instance != null) { AudioService.instance.setQueue(queue); }
                            handler.post(() -> result.success(null));
                        } catch (Exception e) {
                            handler.post(() -> {
                                result.error("UNEXPECTED_ERROR", "Unexpected error", Log.getStackTraceString(e));
                ...
                case "setState": {
                    ...
                    if (AudioService.instance != null) { AudioService.instance.setState(
                            actions,
                            actionBits,
                ...
                case "setAndroidPlaybackInfo": {
                    ...
                    if (AudioService.instance != null) { AudioService.instance.setPlaybackInfo(playbackType, volumeControlType, maxVolume, volume); }
                    result.success(null);
                    break;
                }
                case "notifyChildrenChanged": {
                    ...
                    if (AudioService.instance != null) { AudioService.instance.notifyChildrenChanged(parentMediaId, mapToBundle(options)); }
                    result.success(null);
                    break;
                }
