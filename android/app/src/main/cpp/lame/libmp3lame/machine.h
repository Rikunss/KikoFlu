...
/* Always include standard headers required by C99+ */
#include <stdlib.h>
#include <string.h>
...
/* Define ieee754_float32_t for modern compilers that don't provide it.
   This type is used by LAME's fast_log2() and related functions. */
