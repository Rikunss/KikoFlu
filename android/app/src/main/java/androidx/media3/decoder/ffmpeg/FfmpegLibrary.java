...
// MonotonicNonNull replaced with Nullable for compatibility (checkerframework not in dependencies)
import androidx.annotation.Nullable;
...
public final class FfmpegLibrary {
  ...
  /**
   * Returns the required amount of padding for input buffers in bytes, or {@link C#LENGTH_UNSET}
  ...
  public static boolean supportsFormat(String mimeType) {
    ...
    if (!ffmpegHasDecoder(codecName)) {
      Log.w(
          TAG,
          "No " + codecName + " decoder available. Check the FFmpeg build configuration.");
      return false;
    }
    return true;
  }
  ...
  /**
   * Returns the name of the FFmpeg decoder that could be used to decode the format, or {@code
